    ...
    const addMovieToFavourites = async (movie: any) =>{
        ...
        if (favorites)
        {
            favorites.map(function(favoriteMovie: { title: any }) {
                ...
                {
                    toast.error('Error! Movie already added to favourites!', {
                        ...
                        {(() => {
                            if (tabName === "favourit") {
                                ...
                                return (
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="11" fill="red" className="bi bi-heart-fill" viewBox="0 0 16 16">
